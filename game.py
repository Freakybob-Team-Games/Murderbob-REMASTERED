...
try:
    ...
    #    message2 = ", loud noises,"
    #    message3 = ", and drug references. Proceed with caution."
    #    message4 = "Press ENTER to continue or ESC to quit."
    #    
    #
    #    text1 = font.render(message1, True, RED)
    #    text2 = font.render(message2, True, RED)
    #    text3 = font.render(message3, True, RED)
    #    text4 = small_font.render(message4, True, WHITE)
    #
    ...
    #    screen.blit(text4, (WIDTH // 2 - text3.get_width() // 2, HEIGHT // 2 + text2.get_height() // 2))
    #
    #    pygame.display.flip()
    #
    ...
    print("Exception occured. Closing game after alerting user...")
    messagebox.showerror(title='Exception Occured', message='An error occured and we have to close the game. Sorry!')
    sys.exit()